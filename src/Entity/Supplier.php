...
#[UniqueEntity(fields: ['slug'], message: 'There is already an supplier with this slug')]
class Supplier
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Wine::class, mappedBy: 'supplier')]
